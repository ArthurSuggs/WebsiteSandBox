...
function drawTableForFleetHealth() {
  ...
  if(InfoForSWVersions.airline !== "SPIRIT"){
    InfoForSWVersions.parser = "SWVersions"
    drawTableGeneric(InfoForSWVersions.parser,SWVersionsStruct,'software_table',InfoForSWVersions)
  } else {
    drawTableGeneric(InfoForSWVersions.parser,SWVersionsStructSES,'software_table',InfoForSWVersions)
  }
